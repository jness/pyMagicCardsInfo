...
== Getting prices for a card from TCGplayer
    ...
    >>> card_price = Price(id=160, set='m13')

    >>> card_price.getPrices()
    {'high': u'$0.26', 'card_name': u'Arbor Elf', 'avg': u'$0.13', 'low': u'$0.03'}

== Getting Gatherer Multiverse ID for a card

    >>> from magiccardsinfo.Gatherer import Gatherer

    >>> g = Gatherer(set='m13', id=1)
